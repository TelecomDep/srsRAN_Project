 ...
 */
 ...
 class scheduler_time_lwdf final : public scheduler_policy
 {
 public:
   scheduler_time_lwdf(const scheduler_ue_expert_config& expert_cfg_, du_cell_index_t cell_index);
 ...
 private:
   ...
   // Policy parameters.
   const time_lwdf_scheduler_expert_config params;
   ...
   struct ue_ctxt {
     ue_ctxt(du_ue_index_t ue_index_, du_cell_index_t cell_index_, const scheduler_time_lwdf* parent_);
     ...
     const du_cell_index_t     cell_index;
     const scheduler_time_lwdf* parent;
